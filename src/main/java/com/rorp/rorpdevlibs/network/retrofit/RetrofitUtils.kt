...
import com.rorp.rorpdevlibs.network.exceptions.traceErrorException
...
/*
    ...
    |  _ <  __/ |_| | | (_) |  _| | |_| |_| | |_| | \__ \
    |_| \_\___|\__|_|  \___/|_| |_|\__|\___/ \__|_|_|___/

 */
class RetrofitUtils(private val scope: CoroutineScope, apiResponse: ApiResponse){
